...
- C. PSS INVOICE NUMBER: Zhenghe/PSS prints its internal reference in RED TEXT on the Bill of Lading, in a small annotation block labelled "INVOICE NO.:" (usually near the top). The number after that red "INVOICE NO.:" IS the PSS invoice number — read it directly (e.g. "INVOICE NO.:26060849" -> 26060849, "INVOICE NO.:26081175" -> 26081175). Rules for finding it: (1) PREFER the value from the RED "INVOICE NO.:" block on the BL. (2) It is roughly an 8-digit number, WITH OR WITHOUT a leading "#" (do NOT require a "#"). (3) It is DIFFERENT from the carrier's or forwarder's OWN invoice number (which is printed elsewhere in normal black text, e.g. an Evergreen/SAR invoice number) — never use that. (4) The same red block also usually shows "PO NO.:" and "BL TYPE:" — do not confuse those with the invoice number. If there is genuinely no red "INVOICE NO." block and no other clearly-marked ZHL/PSS reference, return null.
- D. FREIGHT TERM: Look for the wording "OCEAN FREIGHT" anywhere on the document (a line item, the BL, or the charge breakdown). If the term "Ocean Freight" appears AT ALL — with OR without an amount next to it (even if blank, "as arranged", or nil) — output 'PREPAID'. If the term does not appear anywhere, output 'COLLECT'. Do NOT require a dollar figure; the presence of the words alone is enough.
